...
var UsuarioRepository = /** @class */ (function () {
    function UsuarioRepository() {
        this.UserRepository = data_source_1.AppDataSource.getRepository(Usuario_1.Usuario);
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new Error("Houve um erro ao buscar os Usuarios!");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.UserRepository.createQueryBuilder('user').where("user.id = :id", { id: id })];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                    case 2:
                        error_2 = _a.sent();
                        throw new Error("Houve um erro ao buscar o Usuario!");
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.UserRepository.createQueryBuilder('user').where("user.id = :id", { id: object.id })];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                    case 2:

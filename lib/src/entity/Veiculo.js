...
var Veiculo = /** @class */ (function (_super) {
    __extends(Veiculo, _super);
    function Veiculo() {
    ...
    __decorate([
        (0, typeorm_1.Column)(),
        __metadata("design:type", String)
    ], Veiculo.prototype, "fabricante", void 0);
    __decorate([
        (0, typeorm_1.Column)(),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Usuario_1.default; }, function (user) { return user.carro; }),
